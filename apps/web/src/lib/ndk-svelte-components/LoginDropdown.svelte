...
{#if !$ndk.signer}
    <CollapsableDropdown>
        ...
        <ul slot="dropdown-content" class="divide-y divide-base-300 menu p-0 w-60 rounded-box">
            <div>
            ...
            <div class="p-4">
                <div class="flex flex-col items-start px-4">
                    <div class="text-xs">
                        Highlighter is a tool built using the <span class="text-accent">Nostr Protocol</span>, which means you can login using keys instead of a centralized identity provider.
                    </div>
                </div>
            </div>
            <div class="p-4">
