<script lang="ts">
    ...
    import { Avatar, ModalWrapper, Name, PrimaryButton, ndk, nicelyFormattedMilliSatNumber, pay, user as currentUser } from "@kind0/ui-common";
...
<ModalWrapper
    title={modalTitle}
    class="w-full max-w-3xl overflow-y-auto"
>
        {#if profile?.banner}
            <div class="absolute -mt-8 left-0 h-[300px] w-full">
